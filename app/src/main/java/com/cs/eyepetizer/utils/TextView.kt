...
fun TextView.setDrawable(
    ...
    if (iconWidth != null && iconHeight != null) {
        ...
        drawable?.setBounds(0, 0, dp2px(iconWidth).toInt(), dp2px(iconHeight).toInt())
    }
    when (direction) {
...
fun TextView.setDrawables(
    ...
    if (lIconWidth != null && lIconHeight != null) {
        lDrawable?.setBounds(0, 0, dp2px(lIconWidth).toInt(), dp2px(lIconHeight).toInt())
    }
    if (rIconWidth != null && rIconHeight != null) {
        rDrawable?.setBounds(0, 0, dp2px(rIconWidth).toInt(), dp2px(rIconHeight).toInt())
    }
