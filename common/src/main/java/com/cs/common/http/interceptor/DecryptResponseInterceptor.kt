...
import com.cs.common.http.OpenRetrofitClient.HEADER_NO_ENCRYPT
import com.cs.common.http.OpenRetrofitClient.HEADER_NO_ENCRYPT_REQUEST
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        if (response.isSuccessful) {
            ...
            try {
                ...
                Logs.loge("${request.url.toUrl()} <---解密失败！原始报文：$originalString")
            }
        }
